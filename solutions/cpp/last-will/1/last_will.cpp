...
namespace estate_executor {
    ...
    int assemble_code() {
        int red{khan::red::code_fragment() + zhang::red::code_fragment() + garcia::red::code_fragment()};
        int blue{khan::blue::code_fragment() + zhang::blue::code_fragment() + garcia::blue::code_fragment()};
        return(red * blue);
    }
}